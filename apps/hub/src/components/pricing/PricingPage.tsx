...
export function PricingPage() {
  ...
  return (
    ...
    <div style={{ paddingTop: 'calc(var(--bar-h) + 32px)', minHeight: '100vh' }}>
      ...
      {/* ── HEADER ─────────────────────────────────────────────── */}
      <div style={{ textAlign: 'center', padding: 'clamp(3rem,6vw,5rem) clamp(1rem,5vw,2rem) clamp(2.5rem,5vw,3.5rem)' }}>
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.4rem', padding: '0.22rem 0.75rem', borderRadius: 100, background: 'var(--accent-light)', border: '1px solid var(--border2)', color: 'var(--accent-primary)', fontSize: '0.62rem', letterSpacing: '0.1em', textTransform: 'uppercase' as const, marginBottom: '1.2rem', fontWeight: 600 }}>
          {t('pricing.badge')}
        </div>
        <h1 style={{ fontSize: 'clamp(2rem,5vw,3rem)', marginBottom: '0.9rem' }}>
          {t('pricing.title')}
        </h1>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.75rem', marginBottom: '2.5rem' }}>
          ...
          <button onClick={() => setYearly(y => !y)} style={{ width: 44, height: 24, borderRadius: 12, border: 'none', cursor: 'pointer', background: yearly ? 'var(--accent-primary)' : 'var(--card2)', position: 'relative', transition: 'background 0.25s', padding: 0 }}>
      ...
      <div style={{ maxWidth: 1120, margin: '0 auto', padding: '0.5rem clamp(1rem,4vw,2rem) 5rem' }}>
        ...
        {platform === 'bundle' ? (
          ...
          <div style={{ display: 'flex', justifyContent: 'center', paddingTop: '1rem' }}>
            <div style={{ maxWidth: 520, width: '100%', borderRadius: 12, padding: 'clamp(1.8rem,5vw,2.8rem)', border: '2px solid var(--accent-primary)', background: 'var(--card2)', position: 'relative', overflow: 'hidden', textAlign: 'center' }}>
              {/* Top accent */}
              <div style={{ position: 'absolute', top: 0, left: 0, right: 0, height: 2, background: 'var(--accent-primary)' }} />
              {/* Icon */}
              <div style={{ width: 56, height: 56, borderRadius: 16, background: 'var(--accent-light)', border: '1px solid var(--border2)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 1.2rem', color: 'var(--accent-primary)' }}>
                <BundleIcon />
              </div>
              <div style={{ fontFamily: 'Georgia, serif', fontStyle: 'italic', fontSize: '1.4rem', marginBottom: '0.3rem' }}>{BUNDLE.name}</div>
              ...
              <div style={{ display: 'flex', justifyContent: 'center', gap: '2rem', marginBottom: '2rem' }}>
                ...
                <div>
                  ...
                  <div style={{ fontFamily: 'var(--font-mono)', fontWeight: 700, fontSize: '2.4rem', color: 'var(--accent-primary)', letterSpacing: '-0.04em', lineHeight: 1, display: 'flex', alignItems: 'baseline', gap: '0.2rem' }}>
                    {yearly
              ...
              return (
                ...
                >
                  ...
                  <div style={{ display: 'flex', gap: '0.4rem', marginBottom: '1.2rem', flexWrap: 'wrap', minHeight: 24 }}>
                    {plan.popular && <span style={{ padding: '0.18rem 0.55rem', background: 'var(--accent-light)', color: 'var(--accent-primary)', fontSize: '0.6rem', letterSpacing: '0.1em', borderRadius: 4, border: '1px solid var(--border2)', fontWeight: 700 }}>{t('pricing.popular')}</span>}
                  ...
                  <div style={{ fontWeight: 600, fontSize: '1.05rem', color: plan.color, marginBottom: '1rem' }}>{plan.name}</div>

                  <div style={{ fontFamily: 'var(--font-mono)', fontWeight: 700, fontSize: '2.4rem', letterSpacing: '-0.02em', lineHeight: 1, marginBottom: '0.3rem' }}>
        ...
        <div style={{ margin: '2.5rem 0 1.5rem', padding: 'clamp(1.2rem,3vw,1.8rem)', borderRadius: 10, background: 'var(--card2)', border: '1px solid var(--border)', display: 'flex', alignItems: 'flex-start', gap: '1.2rem', flexWrap: 'wrap' }}>
          <div style={{ flexShrink: 0, marginTop: '2px' }}><ShieldIcon /></div>
          <div>
            <div style={{ fontWeight: 600, fontSize: 'clamp(0.95rem,2.5vw,1.1rem)', marginBottom: '0.3rem' }}>{t('pricing.guarantee.title')}</div>
